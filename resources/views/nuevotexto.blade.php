...
<div class="block mx-auto my-12 p-8 bg-white w-2/3 border border-gray-200 rounded-lg shadow-lg">
	...
	<form class="mt-4" method="POST" action="">
		...
		<div id="datostexto">
			...
			<input onkeyup="mostrarFormulario()" type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Asignatura" name="asignatura" id="asignatura"> 
			<br>	

			<label class="font-semibold">¿Cúal es el nombre del profesor a quíen se presentará el texto?</label>
			<input onkeyup="mostrarFormulario()" type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Docente" name="docente" id="docente"> 		
			<br>
		</div>
		...
		<div id="titulodiv">
			...
			<input onkeyup="mostrarFormulario()" type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Título" name="titulo" id="titulo"> 
			<br>	
 		</div>
		...
		<div id="pclavediv">
			...
			<input onkeyup="mostrarFormulario()" type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Palabras Clave" name="pclave" id="pclave"> 
		...
		<div id="lluviaideasdiv">
			...
			<input onkeyup="mostrarFormulario()" class="w-1/2" type="file" id="lluviaideasimg" name="lluviaideasimg" accept="image/png, image/jpeg" />			
			<br>	
 		</div>
		...
		<div id="resumendiv">
			...
			<br>
			<textarea onkeyup="mostrarFormulario()" rows="4" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Resumen" name="resumen" id="resumen"></textarea>
			<br>
 		...
 		<div id="introducciondiv">
			...
			<br>
			<textarea onkeyup="mostrarFormulario()" rows="5" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" name="introduccion" placeholder="Introducción" id="introduccion"></textarea>
			<br>
			<br>
 		...
 		<div id="desarrollodiv">
			...
			<br>
			<textarea onkeyup="mostrarFormulario()" rows="5" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Desarrollo" name="desarrollo" id="desarrollo"></textarea>
			<br>
			<br>
			<a href="" class="font-semibold text-blue-600">Añadir referencia bibliográfica</a> 
			<br>	
 		...
 		<div id="conclusiondiv">
			...
			<br>
			<textarea onkeyup="mostrarFormulario()" rows="5" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Conclusión"  name="conclusion" id="conclusion"></textarea>
			<br>	
 		</div>

 		<input hidden type="text" value="0" name="contador" id="contador">

		<button type="submit" class="rounded-md bg-poli-azuloscuro w-full text-lg text-white font-semibold p-2 my-3">Guardar</button>
	</form>
</div>
